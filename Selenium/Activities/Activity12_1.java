...
public class Activity12_1 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(button1.getText());
        System.out.println(button1.getCssValue("background-color"));
        /*WebElement newButton1=driver.findElement(By.id("actionButton"));
        System.out.println(newButton1.getText());
        System.out.println(newButton1.getCssValue("background-color"));*/
